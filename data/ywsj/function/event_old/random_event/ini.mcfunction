...
execute if score e e156 matches 1 run tellraw @a [{"text": "合成一个轻质测重压力板","color": "light_purple"}]
execute if score e e157 matches 1 run tellraw @a [{"text": "合成一个重质测重压力板","color": "light_purple"}]
execute if score e e158 matches 1 run tellraw @a [{"text": "制作一个粗铁","color": "light_purple"}]
execute if score e e159 matches 1 run tellraw @a [{"text": "挖掘一个粗铁块","color": "light_purple"}]
execute if score e e160 matches 1 run tellraw @a [{"text": "挖掘一个铁块","color": "light_purple"}]
execute if score e e161 matches 1 run tellraw @a [{"text": "制作一个粗金","color": "light_purple"}]
execute if score e e162 matches 1 run tellraw @a [{"text": "挖掘一个粗金块","color": "light_purple"}]
execute if score e e163 matches 1 run tellraw @a [{"text": "挖掘一个金块","color": "light_purple"}]
execute if score e e164 matches 1 run tellraw @a [{"text": "制作一个粗铜","color": "light_purple"}]
execute if score e e165 matches 1 run tellraw @a [{"text": "挖掘一个粗铜块","color": "light_purple"}]
execute if score e e166 matches 1 run tellraw @a [{"text": "挖掘一个铜块","color": "light_purple"}]
execute if score e e167 matches 1 run tellraw @a [{"text": "制作一个避雷针","color": "light_purple"}]
execute if score e e168 matches 1 run tellraw @a [{"text": "聊天栏输入“/trigger 168”","color": "light_purple"}]
execute if score e e169 matches 1 run tellraw @a [{"text": "拾取任意一种可被染色的物品(需由实体扔出)","color": "light_purple"}]
