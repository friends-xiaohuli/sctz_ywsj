...
execute if score mode mode matches 0 run tellraw @s [{"text": "当前模式：","bold": true,"color": "green"},{"text":"默认模式：正向扣分","bold": true,"color": "dark_purple"}]
execute if score mode mode matches 1 run tellraw @s [{"text": "当前模式：","bold": true,"color": "green"},{"text":"独占模式：仅有1人可完成事件","bold": true,"color": "dark_purple"}]
tellraw @s [{"text": "==========【模式选择】==========","bold": true,"color": "dark_green"}]
tellraw @s [{"text":"[默认模式]：正向扣分","color": "dark_red","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_mode0"}}]
tellraw @s [{"text":"[独占模式]：仅有1人可完成事件","color": "dark_red","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_mode1"}}]
