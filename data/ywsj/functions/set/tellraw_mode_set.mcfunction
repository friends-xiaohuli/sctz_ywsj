...
tellraw @s [{"text": "#【请选择模式】","bold": true,"color": "dark_green"}]
tellraw @s [{"text":"§6§l[默认模式]：未完成事件则扣分","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_mode0"}}]
tellraw @s [{"text":"§6§l[独占模式]：仅有一人可完成事件","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_mode1"}}]
...
tellraw @s [{"text": "事件时间（默认30s）：","bold": true,"color": "green","hoverEvent":{"action":"show_text","value":{"text":"单个事件可以完成的时间"}}},{"score":{"name":"ts","objective":"game"},"bold": true,"color": "dark_red"}]
tellraw @s [{"text":"    §6§l[30s]","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_ts_30"}},{"text":"    §6§l[60s]","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_ts_60"}},{"text":"    §6§l[180s]","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_ts_180"}},{"text":"    §6§l[300s]","clickEvent":{"action":"run_command","value":"/function ywsj:set/set_ts_300"}}]
