...
tellraw @a [{"text": "\n==[事件","color": "dark_red","bold": true},{"score":{"name":"event","objective":"time"},"bold": true,"color": "dark_red"},{"text": "#","color": "dark_red","bold": true},{"score":{"name":"time","objective":"time"},"bold": true,"color": "dark_red"},{"text": "]==","color": "dark_red","bold": true}]
