execute if score ecd game matches 1 run execute if score cd countdown matches ..0 run execute if score sptime time matches ..300 run execute if predicate ywsj:5pa run scoreboard players add sptime time 1
