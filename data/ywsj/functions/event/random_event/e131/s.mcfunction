...
execute if score e e131 matches 1 run scoreboard players add s end 1
execute if score e e131 matches 1 run tag @s add es
...
execute if score e e131 matches 1 run function ywsj:event/random_event/event_end