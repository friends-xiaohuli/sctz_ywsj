...
execute as @a run execute if score @s e4 matches 1 run execute store result score s end run tag @s add es
execute as @a run execute if score @s e4 matches 0 run execute store result score f end run tag @s add ef
